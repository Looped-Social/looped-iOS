...
struct MockConversations {
    ...
    static let conversationUsers: [User] = [
        ...
        User(
            ...
            handle: "jitendra",
            company: "Anthropic",
            bio: "Manager at Anthropic",
            profileImageURL: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&h=100&fit=crop&crop=face",
            isVerified: true,
            isAnonymous: false,
            createdAt: Calendar.current.date(byAdding: .month, value: -2, to: Date())!,
            updatedAt: Date()
